...
from reading_multiple_choice.views import create_reading_multiple_choice, update_reading_multiple_choice, delete_reading_multiple_choice, all_details_reading_multiple_choice

app_name = 'reading_multiple_choice'

urlpatterns = [
    path('new-rmmcq-test/', create_reading_multiple_choice, name='create_test'),
    path('test/all_rmmcq/', all_details_reading_multiple_choice, name='all_rmmcq_test'),
