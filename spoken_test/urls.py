...
from spoken_test.views import create_spoken_text, update_spoken_text, delete_spoken_text, all_details_spoken_text

app_name = 'spoken_test'

urlpatterns = [
    path('new-test/', create_spoken_text, name='create_test'),
    path('test/details/', all_details_spoken_text, name='all_tests'),
